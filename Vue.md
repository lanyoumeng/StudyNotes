...
![image-20231215162824490](C:\Users\to'm\AppData\Roaming\Typora\typora-user-images\image-20231215162824490.png)
...
![image-20240113192256544](C:\Users\to'm\AppData\Roaming\Typora\typora-user-images\image-20240113192256544.png)

![image-20240113192742948](C:\Users\to'm\AppData\Roaming\Typora\typora-user-images\image-20240113192742948.png)



![image-20240113192754575](C:\Users\to'm\AppData\Roaming\Typora\typora-user-images\image-20240113192754575.png)
...
2. **模板绑定**：在模板中，您可以使用双括号语法(`{{ message }}`)将数据属性绑定到视图，这样数据将显示在页面上。
...
3. **双向数据绑定**：Vue.js还提供了`v-model`指令，用于实现双向数据绑定，可以用于表单元素。
...
4. **方法和计算属性**：您可以在Vue组件中定义方法和计算属性来处理数据的变化和计算。
...
5. **自动更新**：当数据属性发生变化时，Vue.js会自动更新视图，这意味着无需手动操作DOM来反映数据的变化。

```javascript
this.message = "New message"; // 视图会自动更新
```

6. **数据响应性**：Vue.js使用虚拟DOM和数据观察机制来实现数据的响应性，以最小化DOM更新操作，提高性能。
...
2. `v-bind`：`v-bind` 是Vue.js提供的指令，用于动态地绑定属性的值。您可以使用 `v-bind` 来将属性绑定到组件的数据或表达式。语法是 `v-bind:属性名="表达式"`。
...
3. `{{}}`：花括号 `{{}}` 用于插值，它允许您在模板中嵌入变量或表达式的值，从而将其渲染到页面中。这主要用于在模板中显示文本内容，而不是绑定属性。

   双括号会将其内的变量解析成纯文本

4. `v-model`：`v-model` 是Vue.js提供的双向数据绑定指令，用于在表单元素（如输入框、单选按钮、复选框等）和组件的数据属性之间建立双向绑定。
...
5. v-once指令实现，被这个指令设置的组件在进行变量插值时只会插值一次，例如：
...
![image-20240113173500005](C:\Users\to'm\AppData\Roaming\Typora\typora-user-images\image-20240113173500005.png)

![image-20240113173509230](C:\Users\to'm\AppData\Roaming\Typora\typora-user-images\image-20240113173509230.png)
...
1. **`v-for`**：用于渲染循环中的元素，允许您遍历数组或对象并生成多个元素。
   ...
   ![image-20231215093034787](C:\Users\to'm\AppData\Roaming\Typora\typora-user-images\image-20231215093034787.png)

   ![image-20231215093207473](C:\Users\to'm\AppData\Roaming\Typora\typora-user-images\image-20231215093207473.png)

   在实际开发中，原始的列表数据往往并不适合直接渲染到页面，v-for指令支持在渲染前对数据进行额外的处理，修改标签如下：

   ![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/37b711a27676f6fb109cfbab0c650e2f.jpeg)

   上面的代码中，handle为定义的处理函数，在进行渲染前，通过这个函数来对列表数据进行处理。例如，我们可以使用过滤器来进行列表数据的过滤渲染，实现handle函数如下：

   ![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/ecf251c27e532f75f1101bbe3c0b0a5a.jpeg)

   当需要同时循环渲染多个元素时，与v-if指令类似，常用的方式是使用template标签进行包装，例如：

   ![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/f1fabe56a81f8d55c40c5ca872a7a727.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/1564430b5b539f74b5d3a40bccde0025.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/f35d6722437bf1009de312eb1f717791.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/a5e47b1b992764fd615c16c0e076f0af.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/4129f184c0d62fc1fabbf5412fc9b195.jpeg)

在setup方法的最后可以返回一个JavaScript对象，此对象包装的数据可以在组件的其他选项中使用，也可以直接用于HTML模板中，示例如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/60f95bc9d2d2a584ab3de57002c08911.jpeg)

如果不在组件中定义template模板，也可以直接使用setup方法来返回一个渲染函数，当组件将要被展示时，会使用此渲染函数进行渲染。将上面的代码改写如下会有一样的运行效果：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/345311eb81fca02e5dc6bd4055bebb77.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/62c96ff16b6ce38a148b08ee5ae18d53.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/b67cb11e645d449573310bd1502d25a2.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/d0e6a540db368e77311f406cb39680e5.jpeg)
...
<img src="http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/9756666c6c61df547e238a5a59fd8b91.jpeg" alt="img" style="zoom:50%;" />
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/eea1faf0286a01beef05c47949b5a000.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/f33033d04e9bb7179b6217cbbe74ff61.jpeg)
...
<img src="http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/7f00f8275a1e456828f3095f6fd919ff.jpeg" alt="img" style="zoom: 50%;" />
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/6ee9db63861883f8ae41073cd5c441f7.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/600cd0218ba546d510348bc1b1a565e9.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/75e59ba2c472f6cbe59a64daf47e332b.jpeg)

watch方法比watchEffect方法强大的地方在于，其可以分别获取到变化前的值和变化后的值，十分方便地做某些与值的比较相关的业务逻辑。从写法上来说，watch方法也支持同时监听多个数据源，示例如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/8ae6536c178c06a7950e5757b911d58f.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/1a179294a99ac882ba803a3faf4e036b.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/a679553e302640aeaa6eabb9c01fd8ed.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/40725eb68c0acd1764ee68d221c5ca90.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/4fb7c2d77206c3ea9451de00f76c815d.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/9efb9c052bd151dc6b91af02c22a8562.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/5805c7db3fcd173730f9f6169dc8df52.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/2eb52f1f792bb6594958e2518489b01b.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/673f5c6825ff8ff6f8dd1171096c5147.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/35bcdd9991b4f0b3acb2b09aee0c0354.jpeg)

如果一个属性可能是多种类型，可以如下定义：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/92c4761023ae2a8aa19fea58b9974e71.jpeg)

在对属性的默认值进行配置时，如果默认值的获取方式比较复杂，也可以将其定义为函数，函数执行的结果会被当作当前属性的默认值，示例如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/002f0bdceb7d7fa83aaf91de9a6d0076.jpeg)

Vue中props的定义也支持进行自定义的验证，以上面的代码为例，假设组件内需要接收的count属性的值必须大于数值10，则可以通过自定义验证函数实现：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/ecca2c811ee55a29aa5f49296e32c24c.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/0e26f86ede6af30321b2625d051693fe.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/1ebc3632adedf67f329992ebcf5fb47b.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/f3db1f096d002af3ad32e55035676aab.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/0a11347c3487f5242a2010877a71e7ec.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/719948c7b37858d2c1ee81224d094df7.jpeg)

不重名的生命周期函数会被完整混入组件，重名的生命周期函数被混入组件时，
在函数触发时，会先触发Mixin对象中的实现，再触发组件内部的实现，这类似于面向对象编程中子类对父类方法的覆写，例如：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/9ea509295d7552d8cc676b42d666a5a4.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/44c9a619337a9850baa395a350984f7a.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/4b77ef41f77ff3656decd6b3f1cf2c18.jpeg)
...
<img src="http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/680d8e2ae55b783ee298fb4afb8708b3.jpeg" alt="img" style="zoom:50%;" />
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/16711cae8a24f09a401504897de555b0.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/c43f040c87686f7b4c10b8dc2a1fd234.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/f0e8d0f673bf328ef9f913df2fef2b72.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/cba2bafa04e0e6d2fd51b1bc88f6bf2e.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/3eff7956239d864f2b90b94f0062608d.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/190f6afa5306beb96be5e94653ff1009.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/2d9b0de88023f2b782da45aa8e5888eb.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/5ef56de0532190f3ac38a2e16f3726b6.jpeg)

CSS代码如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/e02f5769474665ad6ac429cd440e6f4e.jpeg)

这样，组件的显示或隐藏过程就变得非常流畅。上面的示例代码使用CSS中的transition来实现动画，其实使用animation的关键帧方式定义动画效果也是一样的，CSS示例代码如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/d38fa790a18987bf16141dcf21d1bfde.jpeg)

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/a1266a0468435a71eb1181fae2b04f5c.jpeg)

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/ae5737d7be944abea103afc7f84cdb46.jpeg)

#### 8.3.2　设置动画过程中的监听回调

我们知道，对于组件的加载或卸载过程，有一系列的生命周期函数会被调用。对于Vue中的转场动画来说，也可以注册一系列的函数来对其过程进行监听。示例如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/6c36dbe91eb1714beac1ef36781d5d55.jpeg)

上面注册的回调方法需要在组件的methods选项中实现：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/1b94eb6307f9c28e59e8541b541327c5.jpeg)

有了这些回调函数，可以在组件过渡动画过程中实现复杂的业务逻辑，也可以通过JavaScript来自定义过渡动画，当我们需要自定义过渡动画时，需要将transition组件的CSS属性关掉，代码如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/9ceb7c854889cb03220fe1ad7d93c665.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/b281adb9635584c2e0d86a1c925c9c6b.jpeg)

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/8a2fb5ca2892b9ab4a3301f3fd9b6c18.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/2cbc53bbda60e90ad6051b0a17521678.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/f5c44dcbaf1bb5b80c58b2aaa3a57f2f.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/84bb7739ef5b19fcbeae8a8db600f8f5.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/7fcfd24d78c7bfd765fba87bc61fffed.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/aca155b3bd8157002214199b8f5da1c8.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/27c5f9ff78a27205d07811fadbe440be.jpeg)

图9-3　Vue CLI图形化工具页面

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/e3d94a29320bc9392d83d530ddb10abd.jpeg)

图9-4　对所创建的项目详情进行设置

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/3e70cecd4d2ded1193ae40836ac13a58.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/af74432a3d0c9b1812644c6ddf113f7c.jpeg)

开发环境的依赖如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/564563023ef0e296262e0beb6952e536.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/829a417b610eafcf37a23ea9e3fe8e2c.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/bb84dfc33ad52a811425bad3616c7fe1.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/b74d4b9d4b706459567c24ae72eb11ed.jpeg)

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/75f29ce567f52a3a56a7be9d7090b124.jpeg)

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/56cc7f0a4635c6e8d49f3b2693c76afc.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/674060087feb096da77b3ec117a2dc43.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/1c7beedb634b15e364551830de584173.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/466c1a4bcc1850fbef6bc34a32ceffe9.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/c597e1205bcebc8685a723b43ae27f68.jpeg)

图9-8　使用图形化工具进行依赖管理

可以尝试在图形化工具中进行组件的卸载，单击页面中的“安装依赖”按钮，可以在所有可用的依赖中进行搜索，选择自己需要的进行安装，如图9-9所示。

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/bc14eb90d0c0f819dc23f902e34e12e4.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/d2e22a1ad3ca110a9750ee671f34e7ed.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/0e3a80fe4be351e37f3fb5e41cd6b6ad.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/9fa505fa53bc0990a2bf5cbbd006aa28.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/b3b2b5861aac624a0714badc440d5c47.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/f7dbc379c9fe881fda8dd33555780d4a.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/df29509b7d5845e8888e70c27584034e.jpeg)

修改请求数据的测试代码如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/5f7104b82446229b9ea7231021a4fda1.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/684a301e144df0a74d7173c509db44d1.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/442d975a3187af19eab831492f0e5520.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/82ade2a987693afca5c85c931e493af9.jpeg)

如果需要让某些配置作用于所有请求，即需要重设axios的默认配置，可以使用axios的defaults属性进行配置，例如：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/e444814c375489f22e0a6c14174ffa7d.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/deead21e07d02af9e42a5f7dba53ed9a.jpeg)

（续表）

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/e9c561d5c6116e5ae22b95a35b9d807c.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/94b6b6f20506376f0f36504bef516c43.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/af0bb29659b185299322474003f05022.jpeg)

运行上面的代码，在请求开始前会有弹窗提示。

也可以对请求完成后进行拦截，示例代码如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/6c6cfbf5b65fa28bff69d50574ed000a.jpeg)

在拦截器中，也可以对响应数据进行修改，将修改后的数据返回给请求调用处使用。

需要注意，请求拦截器的添加是和axios请求实例绑定的，后续此实例发起的请求都会被拦截器拦截，但是可以使用如下方式在不需要拦截器的时候将其移除：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/1c233cdfa7285f5aaf9c6b2895ff5fff.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/f5d730d99552c04a4246e6102c2cc1f0.jpeg)

如以上代码所示，从布局结构上，页面分为头部和主体部分两部分。头部布局了一个输入框，用来输入要查询天气的城市名称；主体部分又分为上下两部分，上部分展示当前的天气信息，下部分为一个列表，展示未来几天的天气信息。

实现简单的CSS样式代码如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/61ad4684fc9530b330d56670240fff72.jpeg)

#### 11.3.2　实现天气预报应用的核心逻辑

天气预报组件的JavaScript逻辑代码非常简单，只需要监听用户输入的城市名，进行接口请求，当接口数据返回后，用其来动态地渲染页面即可，示例代码如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/d505db54b88ee172998e5022a722bba3.jpeg)

至此，一个功能完整的实用天气预报应用就开发完成了。可以看到，使用Vue及其生态内的其他UI支持模块、网络支持模块等开发一款应用程序真的非常方便。

运行编写好的组件代码，效果如图11-6所示。

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/62a7068c6bbc2f75b6cb012b168e16a8.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/a8d4fe04700c7e89b8e69504b2f3056f.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/1298e0bc66c397aa1905d8fc45c875d9.jpeg)

Demo2.vue：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/f6fc248d239d3f61f86705ceff4bbb3a.jpeg)

Demo1和Demo2这两个组件作为示例使用，非常简单。修改App.vue文件如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/1feb3fb8ec9e5fb0660d973d6a838758.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/66e40f70992995d1c6e08a1f1f5c47a7.jpeg)

运行上面的代码，单击页面中的两个切换按钮，可以看到对应的内容组件也会发生切换，如图12-1所示。

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/59a1d15bc07e42674b6b752bc47872ea.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/a721a18b7c99993cf14e10f69105f8d6.jpeg)

如以上代码所示，在组件内部可以使用$route属性获取全局的路由对象，路由中定义的参数可以在此对象的params属性中获取到。在main.js中定义路由如下：

import User from './components/User.vue'

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/941fdabb3effd36fcc0fc95219c13330.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/a13edd854fd08114d54355f1da8c3a7c.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/7df926bb07874f89fedbbeb0b30bcba1.jpeg)

修改User.vue的代码如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/2611cbb250e16e40f756f88d1228a273.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/52aa75c027db509f31d030b57247b323.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/096793096527c7952b9b1424b286e7c3.jpeg)

同时，在components文件夹下新建一个名为UserSetting.vue的文件，在其中编写如下代码：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/49c2b8876f03a854d65c3188f16c5481.jpeg)

我们将User组件作为用户中心页面来使用，而UserSetting组件作为用户设置页面来使用。这两个页面所需要的参数不同，用户中心页面需要用户名参数，用户设置页面需要用户编号参数。我们可以在main.js文件中定义路由：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/2651ef5b9a47b9d06e762b7e9b3dc6bf.jpeg)

你会发现，上面的代码中定义的两个路由除了参数名不同外，格式完全一样。这种情况下，我们无法访问用户设置页面，所有符合UserSetting组件的路由规则同时也符合User组件。为了解决这一问题，最简单的方式是加一个静态的前缀路径，例如：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/168b8174db76945db16791cff4391c46.jpeg)

这是一个好方法，但并不是唯一的方法。对于本示例来说，用户中心页面和用户设置页面所需要参数的类型有明显的差异，用户编号必须是数值，用户名则不能是纯数字。因此，可以通过正则约束来实现不同类型的参数匹配到对应的路由组件，示例如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/09145971e6208117d0f3ac8ce11db21a.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/90dfabf5e1ee5138fab7d66418a27372.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/59a69b78111142c02df216f3ffbb7c75.jpeg)

Friends组件只会在用户中心使用，可以将其作为一个子路由进行定义。首先修改User.vue代码如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/6ec211f7b9fdbd18463f0458597ff493.jpeg)

需要注意，User组件本身也是由路由管理的，在User组件内部再使用的<router-view></router-view>标签实际上定义的是二级路由的页面出口。在main.js中定义二级路由如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/3cd6d48051f08cbfd0e5e9a3c69091c8.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/fcf0eadf866c78da990f852449e014a7.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/f31ff7e783f576393a4a1e6f54f4f05c.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/0e9c4faf8526d6bd0cdcb60e4e2b451b.jpeg)

之后，可以使用如下方式进行路由跳转：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/29ea88766a300ab15c6bf6e57a165a6a.jpeg)

如果路由需要查询参数，可以通过query属性进行设置，示例如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/8d13f363a919756472c6abad8e427b7a.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/0ced7b144a67a8f44e911e4906237ede.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/f65b16d2ed388a63c78f843b4220ed8c.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/73dab8e12e555006a1b1146343c679b2.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/6ca1f129cc56b5836586e221f77008b6.jpeg)

在mian.js文件中定义一个新的路由，设置如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/1a98be18d7ab2e40966307b4f556ef2f.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/d0f2cf81c60e94b8d3a452bfba818130.jpeg)

图12-4　进行路由视图的命名

需要注意，对于没有命名的router-view组件，其名字会被默认分配为default，如果编写组件模板如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/6dc223ebb3f1af53ac48e9a775120262.jpeg)

使用如下方式定义路由效果是一样的：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/93521a9caf81ac1c74e0588b8afccde7.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/7d73edc42af5465f72f19ed0bca3b1ae.jpeg)

#### 12.4.4　路由重定向

重定向也是通过路由配置来完成的，与别名的区别在于，重定向会将当前路由映射到另一个路由上，页面的URL会产生改变。例如当用户访问路由'/d/1'时，需要页面渲染'/demo1'路由对应的组件，配置方式如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/7ea6f8918cbb6d61b4c5a37375f2309f.jpeg)

redirect也支持配置为对象，设置对象的name属性可以直接指定命名路由，例如：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/7f78397bbe75d44bbd3824530b273f06.jpeg)

上面的示例代码都是采用静态的方式配置路由重定向的，在实际开发中，更多时候会采用动态的方式配置重定向，例如对于需要用户登录才能访问的页面，当未登录的用户访问此路由时，我们自动将其重定向到登录页面，下面的示例代码将模拟这一过程：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/5db4825a527b7a14ee475bee7ce0fcc8.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/adecee7a08f849b9853aadaba473156f.jpeg)

由于之前在组件的模板内部使用了$route属性，这导致此组件的通用性大大降低，首先将其所有耦合路由的地方去除掉，修改如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/66430d5d2b17419fdf701d4b982913b7.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/d3acefdde4d20dd659c4799bc9df21e2.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/9341eb23732e81af57e675f1032ed029.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/9bca39b51b068d4e54e58c32deca651c.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/44cd9db31bfe29eb181ffa1b585506d4.jpeg)

与定义全局前置守卫类似，也可以注册全局的导航后置回调。与前置守卫不同的是，后置回调不会改变导航本身，但是其对页面的分析和监控十分有用。示例如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/4b3639b0074de9628ee80b4f14f84c6b.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/8e18647f34355769e3f2308b39de1f20.jpeg)

如以上代码所示，当用户访问“/demo1”路由对应的组件时都会被拒绝掉。需要注意，beforeEnter设置的守卫只有在进入路由时会触发，路由的参数变化并不会触发此守卫。

在编写组件时，也可以实现一些方法来为组件定制守卫函数，示例代码如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/4e3ea025764936b811362156b5775475.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/de34609ba455f96a12bad9306282626e.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/88c5a59d24029f7afa259d73dc25b217.jpeg)

我们在Demo1组件中布局了一个按钮元素，在Demo1组件创建完成后，使用addRoute方法动态添加了一条路由，当单击页面上的按钮时，切换到Demo2组件。修改main.js文件中配置路由的部分如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/c68d0bd33cf7c64937554d75ff9fed71.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/2c4894a375c5e143991ba69aecc8cbdf.jpeg)

上面的代码中，路径为“/demo”的路由将会被删除。

在调用addRoute方法时，它其实会返回一个删除回调，我们也可以通过此删除回调来直接删除所添加的路由，代码如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/9faaa561492bc0130bde9fcb2fa3f994.jpeg)

另外，对于已经命名的路由，也可以通过名称来对路由进行删除，示例如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/656d6acf088ff11dc8e00c63dc5db5b4.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/98e350f8f0c36755b5d4054bef1a4713.jpeg)

修改HelloWorld.vue文件如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/75d43086239c4e124c398131f2ecdf9b.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/d43aa16696f82eb9cd216b9f71ee2b83.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/b5f831adaa055d9d6f2fc7fc4eead1cf.jpeg)

下面尝试体验Vuex状态管理的基本功能。首先仿照HelloWorld组件来创建一个新的组件，命名为HelloWorld2.vue，其功能也是一个简单的计数器，代码如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/32fbd4aafdb8c31797fa1bf8ae0ebafc.jpeg)

修改App.vue文件如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/db7a40ba68e0647e614368c2d8f659ba.jpeg)

运行此Vue工程，在页面上可以看到两个计数器，如图13-2所示。

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/afb132260de12a18a26c2ba61eacc712.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/bf6132e1ab353777e28781cf05daeb36.jpeg)

之后就可以在组件中共享count状态了，并且通过提交increment操作来修改此状态。修改HelloWorld与HelloWorld2组件代码如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/814e98e3ba3c7019024d57ee526cbccc.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/19512eecedf2995b16147191e0e647ed.jpeg)

如果组件使用的计算属性的名字与store中定义的状态名字不一致，也可以在mapState中传入对象来进行配置，示例如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/7865be9f84601a0498e67fa73ad1558d.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/465e543b24d8366988ff7c2fbf870c8c.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/827ff34dee5dc7ea4c81b02b4dbd4763.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/b4d6972272ba3dca9d287c1719f352eb.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/841698208adbf47218c27d276c9c46fe.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/c34886578d465526850ad19d195fae46.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/8046569c34f1aaa39b3476a227c30300.jpeg)

之后，就可以使用如下风格的代码来进行状态修改的提交了：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/fc13efa36dcfe9f55b5cb9d7e33faf63.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/b349dfad0f2cc4f692d58ec76d84da05.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/20b4a60c5b7a2dfb6808fd15a36aca39.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/ddec77980e609b021a9e5e3ef9bdb8f5.jpeg)

如以上代码所示，我们创建了两个模块，两个模块中分别定义了不同的状态和Mutation方法。在使用时，提交Mutation的方式和之前并没有什么不同，在使用状态数据时，则需要区分模块，例如修改HelloWorld.vue文件如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/6e6e9762bc176dd1c748a87e82bf932f.jpeg)

修改HelloWorld2.vue文件如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/a5ce101ebbf122ee28fa3de74c8cf6f9.jpeg)
...
![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/7de90d360addf195e15af9a62ef31662.jpeg)

此时这两个模块在命名空间上实现了分离，需要通过如下方式进行使用：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/2c55a25ae7ca50e802af877a8dc90671.jpeg)

Vuex中的Module还有一个非常实用的功能，其支持动态注册，这样在编写代码时，我们可以根据实际需要决定是否新增一个Vuex的store模块。要进行模块的动态注册，直接调用store实例的registerModule即可，示例如下：

![img](http://localhost:8000/a42729b9-e3b9-4b14-b945-639c09eb8c1b/OEBPS/imgs/56c9815719d2b3bd98128d740ca8ea3f.jpeg)
