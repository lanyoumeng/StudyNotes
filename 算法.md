...
子串(段)：原序列中**必须连续**的一段 子序列：原序列中**可以不连续**的一段 注意：元素的**顺序都是原序列中的顺序**
...
用于在范围内移除连续重复的元素。 它并不真正删除元素，而是将重复的元素移到范围的末尾，并返回一个迭代器，指向不重复序列的末尾
...
![多项式除法](https://raw.githubusercontent.com/lanyoumeng/Drawing-bed/main/typora/202407090222306.png?token=AWX6LWQV57QJFZ3675RTS2LGRQXLU)

### 取整与取模的转换

![img](https://raw.githubusercontent.com/lanyoumeng/Drawing-bed/main/typora/202407090223190.png?token=AWX6LWXHR542CIEXBJ736ZLGRQXMU)

![img](https://raw.githubusercontent.com/lanyoumeng/Drawing-bed/main/typora/202407090223068.png?token=AWX6LWXHLQEICZ4Z6Y4CKHLGRQXMQ)
...
![img](https://raw.githubusercontent.com/lanyoumeng/Drawing-bed/main/typora/202407090239219.png?token=AWX6LWXXC3GZ2F7DOXC3FRDGRQZJK)
...
![img](https://raw.githubusercontent.com/lanyoumeng/Drawing-bed/main/typora/202407090239398.png?token=AWX6LWQOPEWHFDSQJIGFVODGRQZKG)
...
![img](https://raw.githubusercontent.com/lanyoumeng/Drawing-bed/main/typora/202407090239180.png?token=AWX6LWUDC32IR66JMVGSYUDGRQZLC)
...
有向无环图才有拓扑排序 拓扑排序是图的所有顶点的一个排列（所有点出现且仅出现一次） 如果图中有点A->B 那么在拓扑排序中点A的位置一定在点B前面 时间复杂度O(N) 拓扑排序的应用：
...
4. 初始条件（Base Case）： 动态规划需要明确初始条件，即最小的子问题的解。
